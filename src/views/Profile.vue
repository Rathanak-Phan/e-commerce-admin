...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4">
    <div class="max-w-3xl mx-auto">
      <h1
        class="text-4xl font-bold text-center mb-10 text-gray-900 dark:text-white"
      >
        {{ userName }}
      </h1>
      ...
      >
        <!-- Cover + Avatar -->
        <div
          class="h-48 bg-gradient-to-r from-indigo-600 to-purple-600 relative"
        >
          <div class="absolute -bottom-20 left-1/2 -translate-x-1/2">
            <div class="relative">
              ...
              <label class="absolute bottom-3 right-3 cursor-pointer">
                ...
                />
                <div
                  class="p-3 bg-indigo-600 hover:bg-indigo-700 rounded-full shadow-lg transition"
                >
              ...
              <div
                v-if="photoError"
                class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full text-white text-6xl font-bold"
              >
                {{ userInitial }}
              </div>
            </div>
          ...
          <form @submit.prevent="saveProfile" class="space-y-8">
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full px-5 py-4 rounded-xl border dark:bg-gray-700 focus:ring-4 focus:ring-indigo-300 resize-none"
              ></textarea>
            </div>
            ...
            <div>
              <label class="block text-sm font-semibold mb-2"
                >Current Photo URL</label
              >
              <input
                :value="form.photoURL || 'Using default photo'"
                readonly
            ...
            <p
              v-if="success"
              class="text-center text-green-600 dark:text-green-400 font-semibold text-lg mt-6"
            >
